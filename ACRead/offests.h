...
#define OFFSET_PLAYERBASEADDRESS   0x0050F4F4
#define PLAYER_HEALTH_OFFSET	   0xF8
#define PLAYER_AMMO_OFFSET		   0x150

//COD WaW OFFSETS

#define OFFSET_ENTITY_LIST		   0x014E7448
#define OFFSET_HEALTH			   0x000001C8
#define OFFSET_POS				   0x00000014
#define OFFSET_POINTS			   0x014EF124
#define VWMATRIX				   0x008E870C
